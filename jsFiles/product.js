...
//   for (let i = 0; i < imgsArray.length; i++) {
//     const img1 = document.createElement("img");
//       img1.src = "/images/" + imgsArray[i];
//     img1.alt = "Product Image";
//     img1.classList.add("img" + i);
//     imgSlider.appendChild(img1);
//     img1.getBoundingClientRect().width;
//     const img2 = document.createElement("img");
//     img2.src = "/images/" + imgsArray[i];
//     img2.alt = "Product Image";
//     imgsListDiv.appendChild(img2);
//     activeImgElement = img2;
//     img2.addEventListener("load", () => {
...
//   zoomDiv.style.backgroundImage = `url(/images/${imgsArray[activeImg]})`;
// }
...
// }
// async function getProduct() {
//     //const req = await fetch(`/Home/GetProduct?${window.location.href.split("?")[1]}&mainProductId=1`);
//     const req = await fetch(`/Home/GetProduct?${window.location.href.split("?")[1]}`);
//   const data = await req.json();
//   product = await data;
//   return data;
// }
...
//     html += `<li style="
//     background-color: ${products[i].color};
// "><a  href="?variantId=${products[i].id}&mainProductId=${products[i].mainColorId}"></a></li>`;
//   }
//   colorsDiv.innerHTML += html;
//   quickSpecifications.appendChild(colorsDiv);
// }
...
//     for (let i = 0; i < value.length; i++) {
//       const li = document.createElement("li");
//       li.innerHTML = `<button href="?variantId=${value[i].id}">
//                     ${value[i].value}
//                   </button>`;
//       li.addEventListener("click", handleClick);
...
//                 <div class="product--img">
//                 <button class="addToCart">Add To Card</button>
//                   <img src="/images/${image}" alt="realted" srcset="">
//                 </div>
//                 <p class="product--name">${name}</p>
//                 <p class="product--price">$${price}</p>
//                 <div class="product--rating">
...
//     html += `
//      <div>
//                 <img src="/images/products/user.png" alt="" srcset="" />
//                 <div class="user--info">
//                   <p class="user--name">${userName}</p>
//                   <p class="review--text">
//                   ${message}
...
//   });
// });
>>>>>>> 7d1685a0c6245d8dfc7f53d13fc449c27475b732
